...
조인(JOIN)
    ...
    테이블을 조인하여 두 개 이상의 테이블에 있는 정보를 볼 수 있음
    
*/

/*
Natural Join 생성
    두 테이블에서 데이터 유형과 이름이 일치하는 열을 기반으로 자동으로 테이블을 조인할 수 있음
*/
...
/*
테이블 자체 조인 - 수정 안된다는 가정 하에 inner join으로 해당됨
...
LEFT OUTER JOIN
    ...
    왼쪽 테이블인 EMPLOYEES 테이블의 모든 행을 검색함
*/
...
/*
FULL OUTER JOIN
    DEPARTMETS, EMPLOYEES 등 해당되는 내용이 없어도
*/
...
/*
Cartesian Product
    조인 조건이 잘못되거나 완전히 생략된 경우 결과는 모든 행 조합이 표시되는 Cartesian Product로 나타남
*/

/*
Cross Join 생성
    CROSS JOIN 절은 두 테이블의 교차 곱을 생성
*/
